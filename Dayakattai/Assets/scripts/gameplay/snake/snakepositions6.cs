...
public class snakepositions6 : MonoBehaviour
{
    public static snakepositions6 instance;
    ...
    public int i = 0,boxcount=0,previousposition=0;
        ...
        else
        {
            if (entrysafezone == 7 || entrysafezone == 13 || entrysafezone == 19 || entrysafezone == 25 || entrysafezone == 31 || entrysafezone == 37 || entrysafezone == 43 || entrysafezone == 49 || entrysafezone == 55 || entrysafezone == 67)
            {
                ...
                if (canmove)
                {
                    if (entrysafezone <= 80)
                    {
                        //GetComponent<positionsscript>().removesnake(previousposition);
